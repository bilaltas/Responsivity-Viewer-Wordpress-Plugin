	...
	<body>
		...
		<div id="functions">
			...
			<div id="sharer" class="inactive">
				<a href="mailto:?Subject=Here is the responsive view of the site&amp;Body=Link: <?=$responsivity->site_url.urlencode($_SERVER['REQUEST_URI'])?>" style="color: #666666;"><i class="fa fa-envelope"></i></a>
			</div>
